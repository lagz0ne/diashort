...
category: feature
parent: c3-1
goal: Provide a DI atom wrapper for Mermaid server-side rendering via browser farm, supporting both required and optional variants for different usage contexts.
---
...
Provide a DI atom wrapper for Mermaid server-side rendering via browser farm, supporting both required and optional variants for different usage contexts.
...
| --- | --- | --- |
| CHROME_PATH | (required) | Path to Chromium executable |
