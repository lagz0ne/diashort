...
**Note:** API Server to SQLite Database is an internal container-to-container dependency via Bun's native bun:sqlite module (in-process, no network). External tool invocation (mmdc, d2) is via subprocess spawning.
